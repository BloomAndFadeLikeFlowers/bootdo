...
//@Aspect
//@Component
public class RequestLogAspect2 {

    private Logger logger = LoggerFactory.getLogger(RequestLogAspect2.class);
...
//        String url = request.getRequestURL().toString();
        ...
        try {
            ...
            //"ip:{},requestMethod:{},url:{},params:{},elapsed:{}ms,responseBody:{}."
            logger.debug(requestMessageFlag + ":{}\t{}\t{}\t{}\t{}ms\t{}", ip, method, uri, params, (endTime - startTime),
